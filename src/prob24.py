...
# has been found.
def get_nth_lexicographic_perm(seq, n, perm=[], permN=0):
    """
    Return a string representation of the nth lexicographic permutation of a
    sorted list seq. A user only needs to pass seq and n; the other two
    ...
    if not seq:
        ...
        return get_nth_lexicographic_perm(seq, n, perm, permN)
    
def prob24():
    return get_nth_lexicographic_perm(range(10), 10**6)
