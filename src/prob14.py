...
###############################################################################
def next_odd_collatz(n):
    """
    Given an odd positive integer n, return next odd value in a Collatz
    sequence, and number of steps taken to reach it.
